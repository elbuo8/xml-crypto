...
module.exports = {    
  ...
  "verify signature": async function (test) {
    ...
    await verifySignature(test, xml, "./test/static/integration/expectedVerify.xml", [
      "//*[local-name(.)='x']", 
      "//*[local-name(.)='y']", 
      "//*[local-name(.)='w']"])
  },
  ...
  "verify signature of complex element": async function (test) {
    ...
    await verifySignature(test, xml,  "./test/static/integration/expectedVerifyComplex.xml", ["//*[local-name(.)='book']"])
  },
  ...
  "should create single root xml document when signing inner node": async function(test) {
    var xml = "<library>" +
                "<book>" +
                  "<name>Harry Potter</name>" +
                "</book>" +
